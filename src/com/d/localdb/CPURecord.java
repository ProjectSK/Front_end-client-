...
public class CPURecord implements Record {
	...
	public static SQLVTable TABLE = new SQLVDatedTable(
			RecordFactory.reflection(CPURecord.class), "CPURecord", "time",
			new SQLVColumn[] {
					new ReflVColumn(CPURecord.class, "time",
							ColumnType.Datetime, true),
					new ReflVColumn(CPURecord.class, "user", ColumnType.Long,
							false),
					new ReflVColumn(CPURecord.class, "system", ColumnType.Long,
							false),
					new ReflVColumn(CPURecord.class, "idle", ColumnType.Long,
							false),
					new ReflVColumn(CPURecord.class, "other", ColumnType.Long,
							false) });
